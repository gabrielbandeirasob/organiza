...
import { LayoutDashboard, FileText, User, Settings, Plus, LogOut, ChevronDown, HelpCircle, ShieldCheck } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView, onAddTransaction }) => {
  ...
  return (
    <aside className="w-64 flex flex-col border-r border-zinc-800 bg-[#0d0d0d] h-screen sticky top-0 overflow-y-auto">
